...
userRouter.post(
    ...
    [
        ...
        check('name', ResponseMessage.MIN_LENGTH + '7 letras').isLength({
            min: 7,
        }),
        ...
        check('password', ResponseMessage.MIN_LENGTH + '8 caracteres').isLength(
            { min: 8 }
        ),
        validateFields,
    ],
...
userRouter.delete(
    '/:idUser',
    [existsElementByParamId('idUser', 'user'), validateFields],
    deleteUser
);
