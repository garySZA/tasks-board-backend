...
projectRouter.get('/:id', [existsProjectByPk, validateFields], getProjectById);
...
projectRouter.post(
    ...
    [
        ...
        check(
            'nameProject',
            'El nombre debe contener mínimo 6 letras'
        ).isLength({ min: 6 }),
        check('idTeam', 'el identificador de equipo es obligatorio').notEmpty(),
        check(
            'idTeam',
            'el identificador de equipo debe ser un número'
        ).isNumeric(),
